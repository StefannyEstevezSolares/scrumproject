from db import crear, ARCHIVOS
from validaciones_utils import validar_fecha, validar_telefono_8_digitos, validar_email
...
def input_clientes():
    ...
    telefono = input( "Ingrese el teléfono (8 dígitos): ").strip()
    ...
    contacto_principal = input(
        "Ingrese el nombre del contacto principal: ").strip()
    ...
    crear(ARCHIVOS["clientes"], registro)
